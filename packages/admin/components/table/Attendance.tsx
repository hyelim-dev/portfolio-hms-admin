...
import { withDemoGuard } from '@/utils/demo'
...
export default function Attendance({ lectureData, students, isTeacher }) {
  ...
  const onSubmit = index => {
    ...
    createAttendance({
      ...
      refetchQueries: [
        {
          query: SEE_ATTENDANCE_ALL_QUERY,
          variables: {
            attendanceDate: attendanceDate,
            lecturesId: lectureData.id,
          },
        ...
        {
          query: SEARCH_ATTENDANCE_QUERY,
          variables: {
            lecturesId: lectureData.id,
            attendanceDate: lectureData.lectureDetails,
          },
        },
      ],
                        ...
                        <Cell key={index}>
                          <BtnCell>
                            <Button
                              ...
                              variant="solid"
                              color="primary"
                              onClick={withDemoGuard(() => openWorkLog(item))}
                            >
                              일지
                            </Button>
        ...
        {!isTeacher && (
          <BtnBox>
            ...
            <Button
              ...
              color="primary"
              className="w-full"
              onClick={withDemoGuard(() => router.push('/message/sms'))}
            >
              SMS발송
            </Button>
          </BtnBox>
